...
```{r p1, fig.cap="Awareness of and holding behavior of digital- and/or cryptocurrencies",fig.subcap=c("Awareness","Holding behavior now or in the past"),fig.asp=1,fig.ncol=2,out.width=".49\\linewidth"}
# p1
...
```{r p34, fig.cap="Intention to hold digital- and/or cryptocurrencies in the future", fig.subcap=c("Has heard and previously held","Has heard but never held"),fig.asp=1,fig.ncol=2,out.width=".49\\linewidth"}
# p3
df_long %>% 
  filter(krybws01 == "Has heard")%>% 
