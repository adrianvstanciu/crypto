...
Cryptocurrencies can be simplified as digital currencies, however, its possibilities go way beyond that. In the late 90s some inventions that resemble digital money were developed but it was only in 2008 that Satoshi Nakamoto, who may be a person or a group of people, released what has become the most successful crpytocurrency so far: Bitcoin. In simple words, Nakamoto's entirely digital currency is based on a chain of mathematical algorithms (i.e., the blockchain technology). The vision was that the centralized financial system as we now know it can one day become de-centralized, namely financial transactions will be possible directly between involved parties (peer-to-peer transactions). By eliminating the role of banks and governmental bodies that secure trust in financial transactions, unnecessary taxes can be also be removed and people can have direct control of their finances, without the need of third parties. Some discuss that there is even the possibility of abolishing global barriers in trade by removing currency exchange. Such ideas have since entered the public knowledge domain and additional cryptocurrencies (e.g., Ethereum and Litecoing) have been released. It is undeniable that the topic is no longer in the underground of our society, but quite the contrary, it is here to stay.

This research sets to explore reasons why some people are interested in such a new form of finance whereas other are against it, or skeptical still. Throughout the paper we refer to digital currencies and cryptocurrencies interchangebly, despite several differences between them [see @Cryptoverze2020]. We focus on human values as possible explanators and seek to understand associations with engagement with cryptocurrencies in the general German population. We look at the associations between human values in the Theory of Basic Human Values [TBHV, @Schwartz2012] and varying cryptocurrency items as formulated in a recent survey by the OECD [@OECD2019]. Data for the study stems from a quota sample in line with the demographics of the German general population and was collected in April 2022.

## Cryptocurrencies

Though they are modern in substance, the most basic principle behind cryptocurrency conception is ancient: the cryptography. The purpose of using a technology over 4,000 years old is to allow direct and private communication between two parties without the involvement of a third one (Gensler 2018). This way of communication if at the very heart of cryptocurrencies and the Internet (Binance Academy 2019). Cryptocurrencies combine cryptography with other technologies that made them feasible, like Bitcoin that uses the blockchain technology to safely store and verify its transactions. Thanks to the combination of an ancient (cryptography) and a rather new technology (blockchain) cryptocurrencies are digital, private and decentralized currencies. [MB]
...
All the present analyses were carried out in R [@R]. All study materials including scripts and data are open access via the GitHub repository [--add github link here---].
