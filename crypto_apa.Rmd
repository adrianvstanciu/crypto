...
_Reasons for acquiring cryptocurrencies_ were measured with a single-item and participants could choose up to three of eleven answers: (1) fear of missing out, (2) for fun, (3) to learn more about cryptocurrencies, (4) win money fast, (5) long-term investment option, (6) inheritance purposes, (7) support of Block-chain technology, (8) online shopping, (9) money transfer, (10) investment portofolio diversification, (11) other reason.
...
We study the link between human values and interest in cryptocurrencies in an explorative manner. First, we look for evidence on limitations of the present sample concerning its representativity to the German general population. To do so, we compare the sample quotas of gender, age and education to the respective population numbers from the German Microcensus, which covers 1% of the persons and households [@ add literature]. Furthermore, we use secondary resources such as published literature [e.g., @Witteetal2020] and available data sets [European Social Survey, @ add literature] to understand how does the present sample fare when compared to the German general population in view of percentage of people with a specific value preference. 

Second, we decompose the present sample according to a gradient from intention creation to behavior. Since the present data was collected with a questionnaire that used strategic filter questions, we can therefore re-trace at the sample level which participants (1) heard of, (2) currently are and (3) intend on holding cryptocurrencies. This funneling out due to study design allows us then to explore at each stage the role of human values. That is, we investigate frequency distributions, density curves, and central tendency indicators (e.g., mean, median) and seek to determine whether human values play comparable roles at each of the three levels mentioned above. 

Finally, we explore associations between human values and beliefs that people associate with the cryptocurrency topic, as well as reasons for either holding nor not holding cryptocurrencies.
