...
[MB] As up to date as cryptocurrencies are, the most basic principle behind their conception is ancient: the cryptography. The purpose of using a technology over 4000 years old is to allow direct and private communication between two parties without the involvement of a third one. This way of communication if at the very heart of cryptocurrencies and the Internet. The available cryptocurrencies nowadays have a combination of cryptography with other technologies that made them feasible as Bitcoin that uses the blockchain technology to safely store and verify its transactions. Thanks to the combination of an ancient (cryptography) and a rather new technology (blockchain) that cryptocurrencies are digital, private and decentralized currencies. [MB]
