...
Since the release of Bitcoin, other many types of cryptocurrencies were created. Despite not all following the same operationalization or using the same technology (blockchain) as Bitcoin, their very nature is still decentralized. Decentralization 
